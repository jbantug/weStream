...
define('tgn_ee_defaultWidth', '640');
define('tgn_ee_defaultYouTubeObjectHeight', '390');
define('tgn_ee_defaultYouTubeIframeHeight', '390');

define('tgn_ee_shortHeight', '302');
define('tgn_ee_defaultHeight', '640');
...
//return('<pre>' . print_r($values, true) . ' - ' . print_r(tgn_ee_parse_shortcode(array('key' => 'X8gBdsBjpJw', 'width' => '604', 'height' => '364'), $values), true) . '</pre>');
	...
	return tgn_ee_youtube_iframe($values);
}

add_shortcode('yt', 'tgn_ee_youtube_shortcode');
