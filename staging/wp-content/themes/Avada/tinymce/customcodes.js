    ...
    tinymce.create('tinymce.plugins.slider', {  
        init : function(ed, url) {  
            ed.addButton('slider', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[slider][slide type="video"][vimeo id="10145153" width="600" height="350"][/slide][slide link=""]image link here[/slide][/slider]');
                }  
            });  
        },  
        createControl : function(n, cm) {  
    ...
    tinymce.create('tinymce.plugins.recent_works', {  
        init : function(ed, url) {  
            ed.addButton('recent_works', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[recent_works cat_id=""][/recent_works]');  
    ...
    tinymce.create('tinymce.plugins.content_boxes', {  
        init : function(ed, url) {  
            ed.addButton('content_boxes', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[content_boxes]<br />[content_box title="Responsive Design" icon="" image="http://theme-fusion.com/avada/wp-content/uploads/2012/07/ico-02.gif" link="http://themeforest.net/user/ThemeFusion" linktext="Learn More"]Avada is fully responsive and can adapt to any screen size. Try resizing your browser window to see the adaptation.[/content_box]<br />[content_box title="Awesome Sliders" icon="" image="http://theme-fusion.com/avada/wp-content/uploads/2012/07/ico-02.gif" link="http://themeforest.net/user/ThemeFusion" linktext="Learn More"]Avada includes the awesome Layer Parallax Slider as well as the popular FlexSlider2. Both are super easy to use![/content_box]<br />[content_box title="Unlimited Colors"  icon="" image="http://theme-fusion.com/avada/wp-content/uploads/2012/07/ico-03.gif" link="http://themeforest.net/user/ThemeFusion" linktext="Learn More"]We included a backend color picker for unlimited color options. Anything can be changed, including the gradients![/content_box]<br />[content_box last="yes" title="500+ Google Fonts" icon="" image="http://theme-fusion.com/avada/wp-content/uploads/2012/07/ico-04.gif" link="http://themeforest.net/user/ThemeFusion" linktext="Learn More"]Avada loves fonts, choose from over 500+ Google Fonts. You can change all headings and body copy with ease![/content_box]<br />[/content_boxes]');  
    ...
    tinymce.create('tinymce.plugins.recent_posts', {  
        init : function(ed, url) {  
            ed.addButton('recent_posts', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[recent_posts columns="3 or 4" number_posts="4" cat_id="" thumbnail="yes" title="yes" meta="yes" excerpt="yes" excerpt_words="15"][/recent_posts]');
    ...
    tinymce.create('tinymce.plugins.social_links', {  
        init : function(ed, url) {  
            ed.addButton('social_links', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[social_links rss="" facebook="" twitter="" dribbble="" google="" linkedin="" blogger="" tumblr="" reddit="" yahoo="" deviantart="" vimeo="" youtube="" pinterest="" digg="" flickr="" forrst="" myspace="" skype=""]');  
    ...
    tinymce.create('tinymce.plugins.clients', {  
        init : function(ed, url) {  
            ed.addButton('clients', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[clients][client link="" image=""][client link="" image=""][client link="" image=""][client link="" image=""][client link="" image=""][/clients]');  
    ...
    tinymce.create('tinymce.plugins.tfprettyphoto', {  
        init : function(ed, url) {  
            ed.addButton('tfprettyphoto', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('<a href="full image link" rel="prettyPhoto"><img src="thumbnail image link" /></a>');  
