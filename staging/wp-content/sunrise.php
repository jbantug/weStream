...
function anytv_add_www($s) { return anytv_begins_with($s, 'www.') ? $s : 'www.' . $s; }
function anytv_begins_with($str, $sub) { return strncmp($str, $sub, strlen($sub)) == 0; }
...
$using_domain = $wpdb->escape( anytv_add_www($_SERVER[ 'HTTP_HOST' ]) );
